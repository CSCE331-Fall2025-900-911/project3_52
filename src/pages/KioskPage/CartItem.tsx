  ...
  return (
    <div className="mb-3 p-3 bg-gray-100 dark:bg-gray-700 rounded-lg flex">
      <div className="flex-grow">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400"><T>Size</T>: {item.size}<T>, Sugar</T>: {item.sugar_level}<T>, 
          Ice</T>: {item.ice_level} <T>, Toppings</T>: {item.toppings.length > 0 ? item.toppings : <T>N/A</T>}
        </p>
      </div>
