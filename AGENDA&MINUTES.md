...
## Agenda Items
- Introductory work for Project 3  
- Discussion of background knowledge required for the project  

---

## Status Update Since Last Meeting
### **Accomplishments**
- Initial GitHub repository set up  
- Completed individual study on relevant technologies: Django, React, Postman, OAuth2  

### **Tasks Completed**

| Task Description | Assigned To | Completed? |
|------------------|-------------|-------------|
| Set up initial GitHub repository | Aidan | Yes |
| Personal studying (“informal” task) | All members | Yes |

---

## Plans Before Next Meeting
- Begin work on assigned components for each member  

### **Task Assignments**

| Task Description | Assigned To |
|------------------|-------------|
| Customer / Cashier View Functionality & UI | Monty Kang |
| Manager View (X/Z Reports, Backend Accessibility, Graphs) | Aaron Liu, Aidan Veselka, Peter Wu |
...
## Agenda Items
- Review progress on previously assigned tasks  
- Clarify task division among team members  

---

## Status Update Since Last Meeting
### **Accomplishments**
- Continued progress on assigned components  

### **Tasks Completed**

| Task Description | Assigned To | Completed? |
|------------------|-------------|-------------|
| Cashier / Customer View UI / Appearance | Monty | No |
| Manager View – X/Z Report | Peter | No |
| Manager View – Graphs | Aidan | No |
| Manager View – Backend / Tables | Aaron | Yes |
| Server Setup | Aidan, Aaron | Yes |

---

## Plans Before Next Meeting
- Complete tasks currently in progress  

### **Task Assignments**

| Task Description | Assigned To |
|------------------|-------------|
| Cashier / Customer View UI / Appearance | Monty Kang |
| Manager View – X/Z Report / Graphs | Aidan Veselka, Peter Wu |
